...
export default function HeroHomeSection({ headline, title }: HeroHomeSection) {
    return (
        <section>
            <div className="container mt-yellow md:h-[75vh] lg:h-[565px] relative">
                <div className="relative w-full h-full py-[110px] md:py-0">
                    ...
                    <img
                        ...
                        alt="Four decorative dots"
                    />
                    <div className="absolute left-0 top-1/2 -translate-y-1/2 w-full hidden lg:block">
                        <div className="row justify-center">
